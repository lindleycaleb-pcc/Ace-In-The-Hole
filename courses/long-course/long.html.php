...
<head>
    <meta charset="UTF-8">
    <title>Ace In The Hole - Long Course - Template</title>
    <meta name="" content="">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href=../../styles/style.css>
    <link rel="stylesheet" href=styles/styles-long-course.css>
</head>
...
<body>
    ...
    <section class="content">
        <h1>Long Course Triathlon</h1>
    </section>

    <div class="price">
        <p>Event Day: <strong>Saturday</strong></p>
        <p>Start Time: <strong>7:00AM</strong></p>
        <p>Event Cost: <strong>$240</strong></p>
    </div>
    ...
    <div class="icons">
        ...
        <div class="course-details">
            <p>Experience the Long Course Triathlon - A challenging 1.2 mile swim, 58
                mile bike course, and a 13.1 mile run to the finish line. Difficulty level
        ...
        <div class="dropdown1">
            ...
            <div id="myDropdown1" class="dropdown-content1">
                <p><strong>1.2 Miles</Strong> - Participants will make two counter-clockwise loops. Large buoys
        ...
        <div class="dropdown2">
            ...
            <div id="myDropdown2" class="dropdown-content2">
                ...
                <p><strong>58 Miles</Strong> - A scenic point-to-point course that travels over gently rolling hills prior
                    to three hard climbs. The bike course will be marked with large directional
                    signage and there will be course marshals at key intersections to help direct
                    you.</p>
            </div>
        </div>
        <div class="dropdown3">
            ...
            <div id="myDropdown3" class="dropdown-content3">
                <p><strong>13.1 Miles</Strong> - A mostly flat loop course on widely paved bike paths that traverse through and
