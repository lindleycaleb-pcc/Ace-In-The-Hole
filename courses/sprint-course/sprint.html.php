...
<head>
    <meta charset="UTF-8">
    <title>Ace In The Hole - Sprint Course - Template</title>
    <meta name="" content="">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href=../../styles/style.css>
    <link rel="stylesheet" href=styles/styles-sprint-course.css>
</head>
...
<body>
    ...
    <section class="content">
        <h1>Sprint Triathlon</h1>
    </section>

    <div class="price">
        <p>Event Day: <strong>Sunday</strong></p>
        <p>Start Time: <strong>8:00AM</strong></p>
        <p>Event Cost: <strong>$90</strong></p>
    </div>
    ...
    <div class="icons">
        ...
        <div class="course-details">
            <p>Experience the Sprint Course Triathlon - This course will offer a 1-loop 1/2 mile
            swim, 28 mile bike course, and a 5km run.</p>
        </div>

        <div class="dropdown1">
            <button onclick="myFunction1()" class="dropbtn1"><strong>Swim</strong><span>+</span></button>
            <div id="myDropdown1" class="dropdown-content1">
                <p><strong>.5 Miles</Strong> - Participants will swim a 1-loop 1/2 mile course.</p>
            </div>
        </div>
        <div class="dropdown2">
            ...
            <div id="myDropdown2" class="dropdown-content2">
                ...
                <p><strong>28 Miles</Strong> - A scenic point-to-point course that travels over gently rolling hills prior
        ...
        <div class="dropdown3">
            ...
            <div id="myDropdown3" class="dropdown-content3">
                <p><strong>5K</Strong> - Last course in the Sprint Triathlon is a 5km run to the finish
                line.</p>
            </div>
        </div>
