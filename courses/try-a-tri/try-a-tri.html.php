...
<head>
    <meta charset="UTF-8">
    <title>Ace In The Hole - Try-A-Tri - Template</title>
    <meta name="" content="">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href=../../styles/style.css>
    <link rel="stylesheet" href="styles/styles-try-a-tri.css"
</head>
...
<body>
    ...
    <div class="price">
        ...
        <p>Start Time: <strong>8:20 AM</strong></p>
        <p>Event Cost: <strong>$65</strong></p>
    </div>
    ...
    <div class="icons">
        ...
        <div class="course-details">
            <p>This novice race is designed for the first time triathlete, those new to the sport,
                our Junior Triathletes. The swim is a shorter, more manageable 1/4 mile distance,
                (instead of the standard 1/2-mile Sprint distance swim), 10 mile bike ride (vs 12
                miles and it's a 2 loop course making it very spectator friendly!) and a flat 2
                mile run (vs 3 mile sprint course).</p>
        </div>

        <div class="dropdown1">
            <button onclick="myFunction1()" class="dropbtn1"><strong>Swim</strong><span>+</span></button>
            <div id="myDropdown1" class="dropdown-content1">
                <p><strong>.25 Miles</Strong> - The swim is a shorter, more manageable 1/4 mile distance,
                (instead of the standard 1/2-mile Sprint distance swim).</p>
            </div>
        </div>
        <div class="dropdown2">
            ...
            <div id="myDropdown2" class="dropdown-content2">
                ...
                <p><strong>10 Miles</Strong> - It's a 2 loop course making it very spectator friendly!</p>
            </div>
        </div>
        <div class="dropdown3">
            <button onclick="myFunction3()" class="dropbtn3"><strong>Run</strong><span>+</span></button>
            <div id="myDropdown3" class="dropdown-content3">
                <p><strong>2 Miles</Strong> - 2 mile run vs the 3 mile Sprint Course.</p>
            </div>
        </div>
