        ...
        <nav>
            ...
            <ul class="nav-list">
                ...
                <li>
                    ...
                    <ul class="nav-dropdown">
                        <li>
                            <a href="<?php echo BASE_URL; ?>/registration/athlete-registration.html.php">Athlete</a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_URL; ?>/registration/volunteer-registration.html.php">Volunteer</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?php echo BASE_URL; ?>/contact/contact.html.php">Contact</a>
                </li>
                <li>
                    <a href="<?php echo BASE_URL; ?>/faq/faq.html.php">FAQs</a>
                </li>
            </ul>
        </nav>
    </div>
